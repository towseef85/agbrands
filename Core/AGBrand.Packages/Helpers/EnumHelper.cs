...
namespace AGBrand.Packages.Helpers
{
    public static class EnumHelper
    {
        ...
        /// <summary>
        /// Define the enum description as follows and the specified description attribute is what
        /// will get returned from this method, otherwise, just the text of the enum name itself.
        ///
        /// public enum MyEnum { [Description("Empty")] None, [Description("First Item")] Item1,
        ...
        ///
        /// public enum MyEnum { [Display(Name = "None")] None, [Display(Name = "Item1")] Item1,
        /// [Display(Name = "Item2")] Item2 }
        /// </summary>
        public static string GetEnumDisplayName(Enum value)
        {
            DisplayNameAttribute att = value.GetEnumAttribute<DisplayNameAttribute>();
        ...
        /// <summary>
        /// Gets a sorted dictionary of the integer and string representations of each item in the
        /// enumeration. The keys are integers and the values are strings.
        /// </summary>
        public static SortedDictionary<int, string> GetValues<T>() where T : struct, IConvertible
        {
            ...
            foreach (T value in Enum.GetValues(enumType))
            {
                ...
                if (attributes != null && attributes.Length > 0)
                {
                    DescriptionAttribute description = attributes[0];
        ...
        /// <summary>
        /// Returns default if it can't parse. If no default found, then throws exception.
        /// </summary>
